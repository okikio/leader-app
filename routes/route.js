...
let tabs = require("../containers/tabs");
let tab_focus = require("../containers/tab-focus");
let hero = require("../containers/hero");
let content = require("../containers/content");
let layer = require("../containers/layer");
let details = require("../containers/details");
let src = require("../containers/src");
let alt = require("../containers/alt");
let tile = require("../containers/tile");
let footbar = require("../containers/footbar");
let img = require("../containers/img");
let css = require("../containers/css");
let js = require("../containers/js");
